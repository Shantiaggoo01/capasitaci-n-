                                        ...
                                        <div class="card">
                                            ...
                                            <div class="row card-body">
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <input id="tamaño" type="text" class="form-control" name="tamaño" value='{{$producto->tamaño}}'>
                                                </div>

                                                <div class="form-group col-6">
                                                    <label for="">Sabor</label>
                                                    <input type="text" class="form-control" name="sabor" value='{{$producto->sabor}}' required>

                                                </div>

                                                <div class="form-group col-6">
                                                    <label for=""><i>Invima</i></label>
                                                    <input id="invima" type="number" class="form-control" name="invima" value='{{$producto->invima}}'>
                                                </div>
                                                <div class="form-group col-6">
                                                    <label for=""><i>Peso</i></label>
                                                    <input id="peso" type="text" class="form-control" name="peso" value='{{$producto->peso}}'>
                                                </div>
